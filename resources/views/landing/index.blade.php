                        ...
                        <th scope="row">
                            <div class="media align-items-center">
                                <div class="media-body">
                                    <a href="{{ route('admin.landing.'.strtolower($section).'.index') }}"><span class="name mb-0 text-sm">{{ __($section) }}</span></a>
                                </div>
                            </div>
                        </th>
                        <td class="text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="{{ route('admin.landing.'.strtolower($section).'.index') }}">{{ __('Edit') }}</a>
                                </div>
                            </div>
                        </td>
                    </tr>
